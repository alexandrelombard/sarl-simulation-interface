...
public class BootAgent extends Agent {
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    if (_greaterThan) {
      final Object countParameter = occurrence.parameters[0];
      agentsCount = Integer.parseInt(countParameter.toString());
    }
    Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER = this.$castSkill(Logging.class, (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING == null || this.$CAPACITY_USE$IO_SARL_CORE_LOGGING.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING = this.$getSkill(Logging.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LOGGING);
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.info((("Spawning simulated agents (" + Integer.valueOf(agentsCount)) + ")..."));
    for (int idx = 0; (idx < agentsCount); idx++) {
      Lifecycle _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER = this.$castSkill(Lifecycle.class, (this.$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE == null || this.$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE = this.$getSkill(Lifecycle.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE);
      _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER.spawn(SimulatedAgent.class);
    }
    ...
    final Procedure1<Agent> _function = (Agent it) -> {
      ...
      SimulationStep _simulationStep = new SimulationStep();
      _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER.emit(_simulationStep);
    };
    _$CAPACITY_USE$IO_SARL_CORE_SCHEDULES$CALLER.every(100, _function);
  }
